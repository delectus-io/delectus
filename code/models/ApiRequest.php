 ...
 * @property string Environment            - 'dev', 'test', 'live' environment request is made under
 ...
 * @property int    ResponseCode           - native code, e.g. 200 or 404
 * @property string ResponseMessage        - empty until request has started process, should have description of ResultCode at end
